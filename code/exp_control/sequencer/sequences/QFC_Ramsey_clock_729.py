...
phase_offset=self.set_variable("float","phase_offset",0,0,8)
...
if pulse2_729:
    ...
    rf_pulse(0.5, (phase+phase_offset)*3.1415926/2., ion=1, transition_param=clock, is_last=True, address=1)
