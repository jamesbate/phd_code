...
TTLsOff(["854 sw","Pi397","Sigma397","dp397","397det","866 sw","729_not_393second","393DP"])
#InitPulse()
seq_wait(7)
#seq_wait(wait_time)
...
#setTTLOn("729 sw",start_time=0,is_last=True)
rf_pulse(3000, 0, ion=1, transition_param='729_Probe', is_last=True, address=1)
seq_wait(1)
