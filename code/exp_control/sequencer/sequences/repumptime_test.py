...
repump_scan=self.set_variable("float","repump_scan",20.000000,1,2e5)
...
rf_pulse(pitime_carrier, 0, ion=1, transition_param='729_Probe', is_last=True, address=1)
setTTLOff("729_not_393second",start_time=0,is_last=True)

ttl_pulse("854 sw",repump_scan,is_last=True)
