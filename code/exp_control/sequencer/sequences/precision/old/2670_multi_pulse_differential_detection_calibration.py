...
pulse_length_scal_729BSB2=self.set_variable("float","pulse_length_scal_729BSB2",1.000000,0.001,1000)
...
FIXEDOFFSET = 396.171;
freq1 = FIXEDOFFSET - 1.5 * SPLITTING * B_FIELD 
freq2 = FIXEDOFFSET - 0.5 * SPLITTING * B_FIELD 
freq3 = FIXEDOFFSET + 0.5 * SPLITTING * B_FIELD 
freq4 = FIXEDOFFSET + 1.5 * SPLITTING * B_FIELD 
freq5 = FIXEDOFFSET + 2.5 * SPLITTING * B_FIELD 
freq6 = offset_freq_267 + 3.5 * SPLITTING * B_FIELD + SIDEBAND
#freq7 = offset_freq_267 + 3.5 * SPLITTING * B_FIELD
create_transition('1', {1:1.}, freq1, amplitude=-7, slope_type="blackman", ion_list={1:0.}, amplitude2=-100, multiplier=0.5)
create_transition('2', {1:1.}, freq2, amplitude=-7, slope_type="blackman", ion_list={1:0.}, amplitude2=-100, multiplier=0.5)
create_transition('3', {1:1.}, freq3, amplitude=-7, slope_type="blackman", ion_list={1:0.}, amplitude2=-100, multiplier=0.5)
create_transition('4', {1:1.}, freq4, amplitude=-7, slope_type="blackman", ion_list={1:0.}, amplitude2=-100, multiplier=0.5)
create_transition('5', {1:1.}, freq5, amplitude=-7, slope_type="blackman", ion_list={1:0.}, amplitude2=-100, multiplier=0.5)
create_transition('6', {1:1.}, freq6, amplitude=power_2670, slope_type="blackman", ion_list={1:0.}, amplitude2=-100, multiplier=0.5)
#create_transition('7', {1:1.}, freq7, amplitude=power_2670, slope_type="blackman", ion_list={1:0.}, amplitude2=-100, multiplier=0.5)
...
rf_729(pulse_length_scal_729BSB2, 0, "BSB", is_last=True)
