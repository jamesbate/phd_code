...
phase_last_729=self.set_variable("float","phase_last_729",0,0,10)
...
scan_resolution = 0.1
if light_shift_pulse and abs(phase_last_729 % (2 * scan_resolution) - scan_resolution) < 0.001:
...
rf_729(0.5, phase_last_729, "myTrans", is_last=True)
