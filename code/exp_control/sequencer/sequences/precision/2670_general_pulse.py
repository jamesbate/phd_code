...
carrier_freq = calculate_alu_pump_freq(+2.5, +3.5, B_FIELD, carrier_offset_2670, polarization)
...
rf_729(1, 0, "Carrier1")  # Carrier 0.5 -> 1.5
rf_729(1, 0, "Carrier2")  # Carrier 0.5 -> -0.5
