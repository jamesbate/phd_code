# Measuring Mean excitation for fixed pulse_length andfor different wait times between initialization and cooling and the 729 pulse.
...
heating_time=self.set_variable("float","heating_time",10.0,1,2e10)
