...
for i in range(120):
    ...
    if opt_pumping:
        ttl_pulse("397det",pump_length,is_last=False)
    ...
    seq_wait(7)
    RamanPulse(raman_length,repump_length,doppler_length)
    seq_wait(7)

#ttl_pulse(["854 sw","Pi397","dp397","866 sw"],det_time,is_last=True)
