...
pi_time=self.set_variable("float","pi_time",1.000000,0,2e5)
...
if pulse1_729:
    rf_729(0.5 * pi_time, 0, "myTrans", is_last=True)

seq_wait(wait_time)

if pulse2_729:
    rf_729(0.5 * pi_time, phase2_729, "myTrans", is_last=True)

#ttl_pulse(["camera trigger"], 100, is_last=False)
