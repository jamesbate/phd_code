...
setTTLOff("729 sw",0,is_last=False)
setTTLOn("7",0,is_last=True)#854 single pass has inverted logic at the momemt
seq_wait(10)
...
#detection
setTTLOff("7",0,is_last=False)
ttl_pulse("866 sw",det_time,is_last=False)
rf_pulse(det_time, 0, ion=1, transition_param='729_Test', is_last=False, address=0)
