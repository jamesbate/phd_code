...
dummy_param=self.set_variable("float","dummy_param",1.000000,1,2e5)
...
ttl_pulse("dp397",det_time,is_last=False)
PMTDetection(det_time)
seq_wait(0.1,start_time = det_time+1)
# Then we do a PMT detection with 866 light OFF
setTTLOff("866 sw",0,is_last=False)
ttl_pulse("Pi397",det_time,is_last=False)
ttl_pulse("dp397",det_time,is_last=False)
PMTDetection(det_time)
seq_wait(0.1,start_time = det_time)
#ttl_pulse("Sequence_Marker",1, is_last=True)
#-----
