...
raman_length=self.set_variable("float","raman_length",10.000000,0.1,2e5)
# Doppler cooling
...
TTLsOff(["854 sw","Pi397","Sigma397","dp397","397det","866 sw","18"])
#TTLsOff("854 sw")
seq_wait(7)
...
for i in range(20):
    ttl_pulse("854 sw",0.1,is_last=False)
    ...
    seq_wait(7)
    ttl_pulse("18",raman_length,is_last=True)
    seq_wait(7)
    #ttl_pulse("18",1,is_last=True)
    #seq_wait(50)
