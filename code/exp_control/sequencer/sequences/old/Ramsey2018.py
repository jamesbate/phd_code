...
second_pulse=self.set_variable("bool","seccond729_pulse",0)
...
if second_pulse:
	seq_wait(wait_time)
	rf_pulse(pulse729_length, phi*3.1415926, ion=1, transition_param='729_Carrier', is_last=True, address=1)
seq_wait(1)
