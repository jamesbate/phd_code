...
ttl_pulse(["854 double", "854 single", "mon 4"], repump_length, is_last=True)
ttl_pulse(["397 double", "397 pi", "mon 2"], doppler_length, is_last=False)
ttl_pulse(["866 double", "866 single", "mon 3"], doppler_length + 20, is_last=True)
PMTDetection(doppler_length, doppler=True)
