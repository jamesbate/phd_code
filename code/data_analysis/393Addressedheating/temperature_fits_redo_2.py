...
#     params = fit_temp.get_opt_parameters()
#     fit_temp.plot_fit(rsb_pulse_length, rsb_me/bsb_me, errorbars = final_error, ax = ax, title = "RSB/BSB Ratio Plot", xlabel = r"Pulse length $\mu s$",ylabel = r"$\frac{\mathrm{RSB Mean Excitation}}{\mathrm{RSB Mean Excitation}}$",label = "n_av: " + str(round(params['C']/(1-params['C']),2)), colour_index=k)
