...
class StateVectorTestCase(unittest.TestCase):
    ...
    def test_normalize(self):
        ...
        self.assertTrue(1-eps<N<1+eps)
        self.assertTrue(1-eps<sv.norm()<1+eps)
    ...
    def test_reduce(self):
        ...
        sv = sv1 ^ sv2 ^ sv3
        self.assertTrue(((sv.reduce((1,2))-sv1)<eps).all())
        self.assertTrue(((sv.reduce((0,2))-sv2)<eps).all())
        self.assertTrue(((sv.reduce((0,1))-sv3)<eps).all())
        self.assertTrue(((sv.reduce(2)-(sv1^sv2))<eps).all())
    ...
    def test_fft(self):
        ...
        self.assertTrue(numpy.abs(ev_x-0.5)<eps)
    ...
    def test_expvalue(self):
        ...
        self.assertTrue(not isinstance(ev1_X, numpy.ndarray))
        self.assertTrue((ev1_X-2)<eps)
        ev_X = sv.expvalue(X, indices=(0))
        self.assertTrue(not isinstance(ev_X, numpy.ndarray))
        self.assertTrue((ev_X-2)<eps)
        Y = numpy.diag((0,1,2))
        ev = sv1.expvalue((X,Y), multi=True)
        self.assertTrue(isinstance(ev, expvalues.ExpectationValueCollection))
...
class StateVectorTrajectoryTestCase(unittest.TestCase):
    ...
    def test_creation(self):
        ...
        sv = statevector.StateVectorTrajectory(list(map(self.sv, t)))
    ...
    def test_diagexpvalue(self):
        ...
        self.assertTrue(isinstance(ev, expvalues.ExpectationValueTrajectory))
